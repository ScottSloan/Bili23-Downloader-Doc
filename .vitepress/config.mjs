...
export default defineConfig({
  ...
  description:
    "跨平台的 B 站视频下载工具，支持现代UI、音视频流分离下载、多线程下载、弹幕与字幕获取、封面提取及元数据刮削，可自定义文件命名与分类，兼容 Windows（含 Win7）、Linux 和 macOS。",
  ...
  themeConfig: {
    ...
    footer: {
      ...
      message:
        '<a href="https://beian.miit.gov.cn/" target="_blank">滇ICP备2023007640号-1</a>',
    },
    search: {
      provider: "local",
      options: {
