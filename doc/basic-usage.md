...
![下载选项对话框示意图](./pic/download_options.png)
...
- **搜索定位**：点击解析按钮下方的“更多选项”图标，打开搜索对话框。输入关键词后会在解析列表中高亮显示相关项。
  <img src="./pic/search_widget.png" alt="搜索结果示意图" loading="lazy" style="max-width: 60%; margin-top: 10px;">
...
![按列排序示意图](./pic/sort_by_column.png)
:::
